const Footer = () => {
      return (
            <footer className="footer footer-center p-10 bg-sky-400 text-primary-content">
  <aside>
    <p className="font-bold text-white font-fon1 text-4xl">
     Forever Yours Weddings</p> 
    <p className="font-bold text-white">
     Forever Yours Weddings <br/>Providing reliable event since 1999
    </p> 
    <p className="text-black">Copyright © 2023 - All right reserved</p>
  </aside> 
                  <nav>
                        <h2 className="text-white font-fon1 text-2xl">Follow on us</h2>
